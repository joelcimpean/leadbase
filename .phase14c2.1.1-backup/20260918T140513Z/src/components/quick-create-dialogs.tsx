  ...
  return (
    <>
      ...
      <ModalShell
        ...
        eyebrow="CRM"
        title={freeLeadLimitReached ? (de ? "Free-Lead bereits verwendet" : "Free lead already used") : (de ? "Lead hinzufügen" : "Add lead")}
        description={freeLeadLimitReached ? (de ? "Free enthält genau einen gespeicherten Lead. Upgrade auf Starter, um weitere Leads hinzuzufügen." : "Free includes exactly one saved lead. Upgrade to Starter to add more leads.") : (de ? "Unternehmen direkt zum CRM hinzufügen, ohne den aktuellen Leads-Workspace zu verlassen." : "Add a company directly to the CRM without leaving the current leads workspace.")}
      >
        {freeLeadLimitReached ? (
          <div className="px-[18px] py-5">
            <div className="rounded-[11px] border border-black/[0.08] bg-[#F7F8FA] p-4 dark:border-white/10 dark:bg-white/[0.03]">
              ...
              <button type="button" onClick={() => { setOpen(false); window.location.href = "/profile"; }} className="mt-4 inline-flex h-[34px] items-center rounded-[10px] bg-[#002BBA] px-3.5 text-[12.5px] font-medium text-white hover:bg-[#00229A]">
      ...
      <ModalShell
        ...
        description={
          projectCreationLocked
            ? (de ? "Im Free-Plan kannst du Leads bis Gewonnen führen, aber keine Projekte anlegen." : "On Free you can move leads to Won, but project creation is available from Starter.")
            : de
        ...
        {projectCreationLocked ? (
          <div className="px-[18px] py-5">
            <div className="rounded-[11px] border border-black/[0.08] bg-[#F7F8FA] p-4 dark:border-white/10 dark:bg-white/[0.03]">
              ...
              <p className="mt-1.5 text-[11.5px] leading-5 text-[#6B7078] dark:text-[#A6ABB4]">{de ? "Ein angenommenes Free-Angebot setzt den Lead weiterhin auf Gewonnen, erstellt aber kein Projekt automatisch." : "An accepted Free proposal still marks the lead Won, but it does not create a project automatically."}</p>
              <button type="button" onClick={() => { setOpen(false); window.location.href = "/profile"; }} className="mt-4 inline-flex h-[34px] items-center rounded-[10px] bg-[#002BBA] px-3.5 text-[12.5px] font-medium text-white hover:bg-[#00229A]">
                {de ? "Auf Starter upgraden" : "Upgrade to Starter"}
              </button>
            </div>
