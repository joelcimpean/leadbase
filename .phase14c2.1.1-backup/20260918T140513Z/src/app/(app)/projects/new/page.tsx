  ...
  if (!planAllowsFeature(planAccess.planId, "project_creation")) {
    return (
      <AccessGatePanel
        ...
        description={language === "de" ? "Im Free-Plan kann ein Lead Gewonnen werden, ohne automatisch ein Projekt anzulegen. Upgrade auf Starter, um Projekte zu erstellen." : "On Free a lead can become Won without automatically creating a project. Upgrade to Starter to create projects."}
