...
export default async function AnalyticsPage({ searchParams }: AnalyticsPageProps) {
  ...
  if (!planAllowsFeature(planAccess.planId, "analytics")) {
    return (
      <AccessGatePanel
        eyebrow={de ? "Plan-Zugriff" : "Plan access"}
        title={de ? "Analytics sind ab Starter verfügbar" : "Analytics are available from Starter"}
        description={de ? "Der Free-Plan konzentriert sich auf den geführten Ein-Lead-Demo-Flow. Upgrade auf Starter, um Analytics für deinen Workspace zu öffnen." : "Free focuses on the guided one-lead demo flow. Upgrade to Starter to unlock workspace analytics."}
        ctaLabel={de ? "Auf Starter upgraden" : "Upgrade to Starter"}
        ctaHref="/profile"
        secondaryLabel={de ? "Zum Dashboard" : "Back to dashboard"}
        secondaryHref="/"
      />
    );
  }
