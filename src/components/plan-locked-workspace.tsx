...
export function PlanLockedWorkspace({
  ...
  return (
    <div className="relative min-h-[100dvh] w-full">
      ...
      <div className="absolute inset-0 z-[40] bg-[rgba(9,10,12,.34)] backdrop-blur-[2px]">
        <div className="sticky top-0 flex h-[100dvh] w-full items-center justify-center p-4 sm:p-8">
