...
export function ProfilePrecisionClient({ initialProfile, accountEmail, initialAvatarUrl, initialBranding, initialDesignDefaults, gmailEmail, initialPlanSelection, initialPlanDialogOpen = false }: {
